  ...
  return (
    <>
      <div className="banner-container w-full h-[430px] bg-white flex justify-start items-start relative">
        ...
        <div className="absolute flex justify-between items-center w-[1024px] h-[150px] shadow bg-white top-[305px] left-1/2 transform-translate -translate-x-1/2 -translate-y-1/2 rounded-[10px]">
          <div className="w-full flex flex-col gap-[10px] p-[25px] search">
            <div className="title text-[var(--black)] flex justify-start items-center">
              <fontawesomeicon
                icon="{faCalendarDays}"
            ...
            <div className="date">
              <input
                ...
                className="p-[16px] w-full text-[var(--black)] rounded-[8px] border border-[var(--blue-light)] outline-none"
              />
            </div>
          </div>
